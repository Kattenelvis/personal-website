<div class="gradient">
	<div class="m-auto w-[80%] max-w-250 bg-indigo-600 p-6 font-bold text-gray-300">
		...
		<div class="mt-6 text-center font-[neuropol] text-shadow-2xs text-shadow-green-700">
			...
			cloudy skies, tropical fish, water, bubbles, glass, lens flare, sprawling patterns,
			"humanism", aero glass, bokeh, Frutiger fonts, abstract tech, auroras, and bright, vibrant
		...
		<div class="mt-6 text-center font-[neuropol] text-shadow-black text-shadow-xs">
			...
			rather than a broader aesthetic. While some referred to the glossy elements as "Web 2.0 Gloss"
			during its mainstream period, this term described a specific aspect of Frutiger Aero rather
			than the aesthetic as a whole. Frutiger Aero encompasses many subgenres and related
			aesthetics, including Frutiger Metro, Technozen, and Frutiger Eco.
		</div>
